...
@Component
class OrderDtoToMultiTaxableOrderConverter(
    ...
    private val productConverter: Converter<ProductDto, MultiTaxableProduct>,
    private val appliedTariffDataConverter: Converter<AppliedTariffDataDto, AppliedTariffData>
): Converter<OrderDto, MultiTaxableOrder> {

    override fun convert(source: OrderDto): MultiTaxableOrder {
        return MultiTaxableOrder(
            ...
            taxableProducts = source.products.map {
