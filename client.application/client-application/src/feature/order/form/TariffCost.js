...
export default function TariffCost({cost}) {
  ...
  return <Paper variant="outlined" 
    ...
    <Grid2 container direction="row" spacing={3}>
      ...
      <Grid2>
        <Typography sx={textSx}>{cost.cost.value + mapUnitMeasurement[cost.cost.currency]}</Typography>
      ...
      <Grid2>
        <Typography sx={textSx}>{cost.resultCost.value + mapUnitMeasurement[cost.resultCost.currency]}</Typography>
